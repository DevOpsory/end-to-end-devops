...
- **Deployment Strategy** – This helps define a structured approach to application deployment. It makes deployments predictable, repeatable and less risky. Popular approaches include canary and blue-green strategies.
